...
export const createList = async (req, res) => {
    ...
    try {
        await List.create({ user_id: id, name })
...
export const updateList = async (req, res) => {
    ...
    try {
        const result = await List.updateOne({ _id: id, user_id }, { $set: { name } })
...
export const deleteList = async (req, res) => {
    ...
    try {
        await List.deleteOne({ _id: id, user_id })
...
export const getList = async (req, res) => {
    ...
    try {
        ...
        const list = await List.findOne({ user_id, _id: id }).select('name otomes')
